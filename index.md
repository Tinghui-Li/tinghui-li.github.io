...
My research interests include **Human-Computer Interaction**, **Extended Reality** (including VR, MR, AR), **Accessibility** (including Situationally-Induced Impairments and Disabilities), and **Ergonomics** -- with a special focus on **Encumbrance and Walking in Mixed Reality** and **Arm Fatigue Model**. I have published in top-tier venues such as CHI, UIST, and IMWUT/UbiComp.
